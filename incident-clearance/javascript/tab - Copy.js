...
$(document).ready(function(){
	...
	$("#Save-5").click(printTime);
	$("#Save-6").click(printTime);
	$("#Save-7").click(printTime);
	$("#Save-8").click(printTime);
	$("#Save-9").click(printTime);
...
function updateSum2(){
	...
	involved_car_s = document.getElementById("dropbox1s").value;
	console.log(involved_car_s);	
	involved_truck_s = document.getElementById("dropbox2s").value;
	console.log(involved_truck_s);
	involved_bus_s = document.getElementById("dropbox3s").value;
	...
	else if ((involved_car != ' ') && (involved_car_s != ' ')&& (involved_truck_s == ' ') &&(involved_bus_s == ' ')){
				model['involved_veh'] = involved_car +'(:' +involved_car_s+')  '+ involved_truck+ involved_bus  + involved_pedestrian + involved_cyclist + involved_motor + 'involved' ;
					$("#Save-5").removeAttr("disabled");
		}
    else if ((involved_car_s == ' ') && (involved_truck != ' ') && (involved_truck_s != ' ')&&(involved_bus_s == ' ')){
				model['involved_veh'] = involved_car + involved_truck+ '(:' +involved_truck_s+')  '+involved_bus  + involved_pedestrian + involved_cyclist + involved_motor + 'involved' ;
					$("#Save-5").removeAttr("disabled");
		} 
    else if ((involved_car_s == ' ') && (involved_truck_s == ' ') &&(involved_bus != ' ') && (involved_bus_s != ' ')){
				model['involved_veh'] = involved_car + involved_truck +  involved_bus  + '(:' +involved_bus_s+')  '+ involved_pedestrian + involved_cyclist + involved_motor + 'involved' ;
					$("#Save-5").removeAttr("disabled");
		}
	else if ((involved_car != ' ') &&(involved_car_s != ' ') && (involved_truck != ' ') && (involved_truck_s != ' ') &&(involved_bus_s == ' ')){
				model['involved_veh'] = involved_car +'(:' +involved_car_s+')  '+ involved_truck+ '(:' +involved_truck_s+')  '+involved_bus  + involved_pedestrian + involved_cyclist + involved_motor + 'involved' ;
					$("#Save-5").removeAttr("disabled");
		}
	else if ((involved_car != ' ') &&(involved_car_s != ' ') && (involved_truck_s == ' ') && (involved_bus != ' ') &&(involved_bus_s != ' ')){
				model['involved_veh'] = involved_car +'(:' +involved_car_s+')  '+ involved_truck+ involved_bus  + '(:' +involved_bus_s+')  '  + involved_pedestrian + involved_cyclist + involved_motor + 'involved' ;
					$("#Save-5").removeAttr("disabled");
		}
	else if ((involved_car_s == ' ') &&(involved_truck != ' ') && (involved_truck_s != ' ') && (involved_bus != ' ') &&(involved_bus_s != ' ')){
				model['involved_veh'] = involved_car + involved_truck+ '(:' +involved_truck_s+')  '+ involved_bus  + '(:' +involved_bus_s+')  '  + involved_pedestrian + involved_cyclist + involved_motor + 'involved' ;
					$("#Save-5").removeAttr("disabled");
		}
	else if ((involved_car != ' ')&&(involved_car_s != ' ')  &&(involved_truck != ' ') && (involved_truck_s != ' ') && (involved_bus != ' ') &&(involved_bus_s != ' ')){
				model['involved_veh'] = involved_car +'(:' +involved_car_s+')  '+ involved_truck+ '(:' +involved_truck_s+')  '+ involved_bus  + '(:' +involved_bus_s+')  '  + involved_pedestrian + involved_cyclist + involved_motor + 'involved' ;
					$("#Save-5").removeAttr("disabled");
		}
	...
	//only one is get checked
	if ((chart_value == '1 CHART unit ') && (police_value == ' ') &&(tow_value == ' ') && (fireboard_value == ' ') && (medical_value == ' ')&& (others_value == ' ')){
				model['responder_number'] = chart_value + 'is responding.' ;
				$("#Save-6").removeAttr("disabled");
		}
    else if ((chart_value == ' ') && (police_value == '1 POLICE unit ') &&(tow_value == ' ') && (fireboard_value == ' ') && (medical_value == ' ')&& (others_value == ' ')){
				model['responder_number'] = police_value + 'is responding.' ;
				$("#Save-6").removeAttr("disabled");
		} 
    else if ((chart_value == ' ') && (police_value == ' ') &&(tow_value == '1 TOW unit ') && (fireboard_value == ' ') && (medical_value == ' ')&& (others_value == ' ')){
				model['responder_number'] = tow_value + 'is responding.' ;
				$("#Save-6").removeAttr("disabled");
		}
	else if ((chart_value == ' ') && (police_value == ' ') &&(tow_value == ' ') && (fireboard_value == '1 FIREBOARD unit ') && (medical_value == ' ')&& (others_value == ' ')){
				model['responder_number'] = fireboard_value + 'is responding.' ;
				$("#Save-6").removeAttr("disabled");
		}
	else if ((chart_value == ' ') && (police_value == ' ') &&(tow_value == ' ') && (fireboard_value == ' ') && (medical_value == '1 MEDICAL unit ')&& (others_value == ' ')){
				model['responder_number'] = medical_value + 'is responding.' ;
				$("#Save-6").removeAttr("disabled");
		}
    else if ((chart_value == ' ') && (police_value == ' ') &&(tow_value == ' ') && (fireboard_value == ' ') && (medical_value == ' ') && (others_value == '1 Other unit ')){
				model['responder_number'] = others_value + 'is responding.' ;
				$("#Save-6").removeAttr("disabled");
		}
...
function getDate(){
	...
	if(((month == '01')&&(day == '01')) || ((month == '01')&&(day == '02')) || ((month == '01')&&(day == '15')&&(year == '2018')) || ((month == '02')&&(day == '19')&&(year == '2018')) || ((month == '05')&&(day == '28')&&(year == '2018')) || ((month == '07')&&(day == '04')) || ((month == '09')&&(day == '03')&&(year == '2018')) || ((month == '10')&&(day == '08')&&(year == '2018')) || ((month == '11')&&(day == '12')&&(year == '2018')) || ((month == '11')&&(day == '22')&&(year == '2018')) || ((month == '12')&&(day == '25')) 
		 || ((month == '01')&&(day == '21')&&(year == '2019')) || ((month == '02')&&(day == '18')&&(year == '2019')) || ((month == '05')&&(day == '27')&&(year == '2019')) || ((month == '09')&&(day == '02')&&(year == '2019')) || ((month == '10')&&(day == '14')&&(year == '2019')) || ((month == '11')&&(day == '11')&&(year == '2019')) || ((month == '11')&&(day == '28')&&(year == '2019'))){
		nonholiday = 1;
		nonholiday_sh = 0;
...
//supplemental rules				
    ...
    model["pavement_condition"]!=null && model["hour_time"]!= null && model["location"]!=null){	
        ...
        if((model['blockage']=='Travel lane blockage') && ((hazmat == true) && ((involved_truck_s == 'over ') || (num_responder >= 10) || (num_chart >= 3))) ){
	        ...
	        drawSVG1(110, 240, 130, 250, "55~120", "90%");
	        drawSVG2(0, 0, 0, 0, "", "");
	        drawSVG3(0, 0, 0, 0, "", "");
	        drawSVG4("Average CT = 80 mins");
	    }		
...
function CPD1_case3(){	
//new rules for april
	drawSVG1(110, 240, 130, 250, "55~120", "60%");
	drawSVG2(90, 240, 110, 250, "45~120", "70%");
	drawSVG3(60, 240, 80, 250, "30~120", "80%");
	drawSVG4("Average CT = 95 mins");
