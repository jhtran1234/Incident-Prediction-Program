...
model["pavement_condition"]!=null && model["hour_time"]!= null && model["location"]!=null){	
	...
	if((model['blockage']=='Travel lane blockage') && ((cpi == 1) || (cpd == 1)) && ((hazmat == true) && ((involved_truck_s == 'over ') || (num_responder >= 10) || (num_chart >= 3))) ){
	...
	else if((model['blockage']=='Travel lane blockage') && ((cpi == 1) || (cpd == 1)) && ((involved_truck_s == 'over ') && ((total_lane >= 4) || (location_choice == 'Harford') || ((cpi == 1) && (num_responder >= 7)))) ){
				drawSVG1(240, 300, 260, 300, ">=120", "90%");
				drawSVG2(0, 0, 0, 0, "", "");
				drawSVG3(0, 0, 0, 0, "", "");
				drawSVG4("Average CT = 200 mins");
	}	
	else if((model['blockage']=='Travel lane blockage') && ((cpi == 1) || (cpd == 1)) && ((involved_truck_s == 'jack ') && (num_tow >= 2) && (hour != 'Day time')) ){
				drawSVG1(240, 300, 260, 300, ">=120", "90%");
				drawSVG2(0, 0, 0, 0, "", "");
				drawSVG3(0, 0, 0, 0, "", "");
				drawSVG4("Average CT = 150 mins");
	}		
	else if((model['blockage']=='Travel lane blockage') && ((cpi == 1) || (cpd == 1)) && (((involved_car_s == 'over ') || (involved_truck_s == 'over ') || (involved_bus_s == 'over ')) && (((weekend == 'Weekend') && (num_responder >= 8)) || ((num_medical >= 1) && (num_tow >= 2)) || ((location_choice == 'Cecil') && (num_responder >= 6)))) ){
				drawSVG1(240, 300, 260, 300, ">=120", "90%");
				drawSVG2(0, 0, 0, 0, "", "");
				drawSVG3(0, 0, 0, 0, "", "");
	...
	else if((model['blockage']=='Travel lane blockage') && (location_choice == 'Baltimore city') && (direction == 'South') && (toll_lane == true) && (hour == 'Night time') && (num_truck > 0) && (num_tow > 0)) {
				drawSVG1(180, 260, 190, 270, "170~180", "90%");				
				drawSVG2(160, 280, 170, 290, "160~190", "100%");
				drawSVG3(0, 0, 0, 0, "", "");
...
function CPD2_updateTime(){
	...
	if(checkresult == 'CPD2-2'){
		...
		else if(pavement == 'Wet' && num_fireboard > 0){checkresult = 'CPD2-3';}
		else if((weekend == 'Weekend') && (hour == 'Night time') && (num_total > 2) && (num_tow > 0)){checkresult = 'CPD2-3';}
		else if((num_total > 3) && (num_responder > 4)){checkresult = 'CPD2-3';}		
		else{checkresult = 'CPD2-2';}
	}	
	if(checkresult == 'CPD2-3'){
		if((weekend == 'Weekend') && (hour == 'Night time') && (num_total > 2)){checkresult = 'CPD2-4';}
